import { UpdateCheckup, CreateMaintenance, UpdateMaintenance, UpdateReparation } from './../../inventory/state/inventory/inventory.actions';
...
@Component({
  ...
  templateUrl: './repair-pending.component.html',
  styleUrls: ['./repair-pending.component.css']
})
export class RepairPendingComponent implements OnInit {
